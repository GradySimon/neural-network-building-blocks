...
**Useful for:** Producing activations between $$0$$ and $$1$$, for example if the activations will be interpreted as probabilities.

### Hyperbolic tangent (tanh)
{: .section-header}

An s-shaped nonlinearity that produces activations between $$-1$$ and $$1$$.
...
**Useful for:** Producing activations between $$-1$$ and $$1$$.
